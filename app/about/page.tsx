          ...
          <div className="grid gap-16 py-16 lg:grid-cols-2 lg:py-24">
            ...
            <div className="relative z-10">
              ...
              <p className="mb-8 max-w-lg text-lg text-white/80">
                Online Labs (OLabs) is a virtual learning platform that provides students
                with interactive laboratory experiments in Physics, Chemistry, Biology,
                Mathematics, and English. Designed for students from classes 9 to 12, OLabs
              ...
              <p className="mb-8 max-w-lg text-lg text-white/80">
                ...
                OLabs ensures every learner has access to quality educational resources.
              </p>
